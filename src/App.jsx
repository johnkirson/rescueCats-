...
// Config and assets
import { DEFAULT_SENSITIVITY, INFER_EVERY_MS, CAT_BASELINE_ABOVE_ROPE_PX, DROP_TRAVEL_BELOW_PX, DROP_MIN_TIME_MS, CAT_LAND_DURATION_MS } from "./config/calibration";
import { MILESTONES } from "./config/constants";
import SPRITES from "./config/sprites";
// Render utilities
import { drawRopeSprite } from "./render/drawRope";
import { drawThreshold } from "./render/drawThreshold";
import { drawPoseMapped } from "./render/drawPose";
import { drawSavedCounter } from "./render/drawHUD";
import { drawSeatedCats, drawActiveCat } from "./render/drawCats";
  ...
  const tick = async ()=>{
    ...
    try{
      ...
      if(Object.keys(imgs).length > 0) {
        ...
        try {
          drawSeatedCats(u,imgs,seatedCatsRef.current);
          drawActiveCat(u,imgs,catRef,stepActiveCat);
        } catch(e) {
